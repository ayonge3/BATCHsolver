...
new_mechanism.elementary_processes[0].forward.k = 0.02# 0.0001#
new_mechanism.elementary_processes[0].backward.k = 0

new_mechanism.elementary_processes[1].forward.k = .0004# 0.0001#
new_mechanism.elementary_processes[1].backward.k = 0.0

new_mechanism.elementary_processes[2].forward.k = 0.0
new_mechanism.elementary_processes[2].backward.k = 1000#0.0001#

new_mechanism.elementary_processes[3].forward.k = 1#0.0001#
new_mechanism.elementary_processes[3].backward.k = 0

new_mechanism.elementary_processes[4].forward.k = .01
new_mechanism.elementary_processes[4].backward.k = 0

new_mechanism.elementary_processes[5].forward.k = .06
...
save_object(opdh_1,'./jinwoo_model.json')
